...
file_name = "Custom.txt".format(product_name)

# Open the file in write mode
with open(file_name, "w+") as text_file:
    # Write the heading
    text_file.write("**** {} Costs ****\n\n".format(product_name))

    # Write variable costs
    text_file.write(expense_print("Variable", variable_frame, variable_sub))
    text_file.write("\n")

    if have_fixed == "yes":
        # Write fixed costs
        text_file.write(expense_print("Fixed", fixed_frame, fixed_sub))
        text_file.write("\n")

    # Write total costs and profit target
    text_file.write("Total Costs: {}\n".format(currency(all_cost)))
    text_file.write("Profit Target: {}\n".format(currency(profit_target)))
    text_file.write("\n")

    # Write selling price
    text_file.write("Selling Price (Un-rounded): {}\n".format(currency(selling_price)))

# Print message
print("Data has been written to the file: {}".format(file_name))
